...
## Project Structure
    ...
    ├── trell_got_prints_29639  # Django project configurations
...
1. Clone this repo and `cd trell_got_prints_29639`
...
2. Clone this repo and `cd trell_got_prints_29639`
